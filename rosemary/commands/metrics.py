...
def metrics_status():
    ...
    from app import db
    from app.modules.hubfile.metrics_extraction import EXTRACTOR_VERSION
...
def metrics_backfill(force: bool, limit: int | None, batch_size: int):
    from app import db
    from app.modules.hubfile.metrics_extraction import EXTRACTOR_VERSION, extract_metrics
    from app.modules.hubfile.models import Hubfile, HubfileMetrics
